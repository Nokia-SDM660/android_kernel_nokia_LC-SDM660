...
static void fts_gesture_report(struct input_dev *input_dev, int gesture_id)
{
    ...
    case GESTURE_DOUBLECLICK:
        gesture = KEY_GESTURE_WAKEUP; //modify by shenwenbin for open double tap wakeup 20190516
        break;
    case GESTURE_O:
...
int fts_gesture_init(struct fts_ts_data *ts_data)
{
    ...
    input_set_capability(input_dev, EV_KEY, KEY_GESTURE_WAKEUP);        /*modify by shenwenbin for open double tap wakeup 20190516 begin*/
    ...
    __set_bit(KEY_GESTURE_WAKEUP, input_dev->keybit);   /*modify by shenwenbin for open double tap wakeup 20190516 begin*/
